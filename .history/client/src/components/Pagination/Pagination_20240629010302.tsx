  ...
  const check = (arr:any)=>{
    console.log(arr);
      const newArr = arr?.filter((item:any)=>{
        if(
          item?.categoryCode.toLowerCase() === postLimit?.categoryCode.toLowerCase()  ||
          item?.address.toLowerCase() ===  postLimit?.provinceCode.toLowerCase() ||
          item?.attributes.acreage.toLowerCase() === postLimit?.area2Code.toLowerCase() ||
          item?.attributes.price.toLowerCase() === postLimit?.priceCode.toLowerCase()
        ){
          // console.log(item);
          return item
        }
