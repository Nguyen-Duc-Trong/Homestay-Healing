                ...
                <div className='w-[60%] ml-[15px]'>
                    ...
                    <div className='flex justify-between'>
                        <div className='flex items-center '>
                            <img src="https://res.cloudinary.com/drorqx56b/image/upload/v1720143468/Homstay%20Healing/default-user_-_Copy_toudvy.png" alt="" className='w-[30px] h-[30px] object-cover rounded-full mr-[5px]' />
                            <p>{users?.name}</p>
                        </div>
                        <div className='flex'>
