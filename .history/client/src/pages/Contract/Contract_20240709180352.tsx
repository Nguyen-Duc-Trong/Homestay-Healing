                            ...
                            <div className='absolute bottom-[0px] w-[100%]'>
                                {
                                    item?.accept ?
                                        ...
                                        :
                                        <Button text={'Thanh Lý Hợp Đồng'} onClick={() => handleSettlement(item)} className={'w-full rounded-t-[0px] text-center bg-[#febb02] hover:no-underline'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined} />
                                }
                            </div>
