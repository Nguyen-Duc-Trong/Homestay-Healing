                    ...
                    return(
                        <div key={index} className="w-[47%] h-[400px] shadow-xl relative m-auto border-[1px] mt-0 mb-[15px] rounded-[8px]">
                            ...
                            <div className='absolute bottom-[0px] w-[100%]'>
                                {
                                    item?.accept === 1 ?
                                        <Button text={`Xác nhận`} onClick={handleShowQR} className={'w-full rounded-t-[0px] text-center  bg-green-500 hover:no-underline'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined} />
                                        :
