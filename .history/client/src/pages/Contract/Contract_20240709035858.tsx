                    ...
                    return(
                        <div key={index} className="w-[47%] h-[400px] relative m-auto border-[1px] mt-0 mb-[15px] rounded-[8px]">
                            ...
                            <div className='absolute bottom-[0px] w-[100%]'>
                                {
                                    item?.accept ?
                                        <Button text={`Xác nhận`} onClick={undefined} className={'w-full rounded-t-0 text-center bg-yellow-500 hover:no-underline'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined} />
                                        :
