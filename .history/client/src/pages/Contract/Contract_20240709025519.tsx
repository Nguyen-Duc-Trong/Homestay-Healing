                ...
                {dataContract?.map((item:any, index:any) => {
                    return(
                        <div key={index} className="w-[47%] m-auto border-[1px] mt-0 p-[10px] mb-[15px]">
                            ...
                            <Button text={'Thanh Lý Hợp Đồng'} onClick={} className={'w-full text-center bg-yellow-500 hover:no-underline'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined}/>
