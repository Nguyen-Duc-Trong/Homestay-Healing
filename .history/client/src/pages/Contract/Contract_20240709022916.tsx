                ...
                {dataContract?.map((item:any, index:any) => {
                    return(
                        <div key={index} className="w-[47%] m-auto border-[1px] mt-0 p-[10px]">
                            ...
                            <Button text={'Thanh Lý Hợp Đồng'} onClick={undefined} className={'w-full text-center bg-yellow-500'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined}/>
                        </div>
                    )
                })}
            </div>
