                    ...
                    posts.map((item:any, index:any)=>{
                      return (
                          <tr className='my-[10px]' key={index}>
                            ...
                            <td   className=' border-[2px]'><button className='font-[500] w-[100%] h-[100%] bg-red-300'>Xóa</button> </td>
                            <td   className=' border-[2px]'><button className='font-[500] w-[100%] h-[100%] bg-yellow-200'>Sửa</button> </td>
                          </tr>
                      )
                    })
                :
