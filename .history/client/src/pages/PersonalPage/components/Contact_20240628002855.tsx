...
const Contact = () => {
  return (
    <div className='bg-white rounded-md w-[100%] h-[100%] shadow-md p-4 w-3/5 flex flex-col justify-center items-center gap-6'>
    <img
        src={text.image}
        alt="thumbnal"
        className='w-[70%] h-[100%] x object-contain'
    />
    <p>{text.content}</p>
