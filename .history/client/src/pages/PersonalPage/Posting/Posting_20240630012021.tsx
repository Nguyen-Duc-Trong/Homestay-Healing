...
const Posting = () => {
  ...
  const handleFile = async (e:any) => {
    ...
    setPayload(
      ...
      // (prev:any) => ({ ...prev, images: [...prev.images, ...images] })
    )
    console.log(images);
  }
        ...
        <div className="flex pb-[200px]">
          <div className="w-2/3">
            ...
            <div className="w-full">
              ...
              <div className="">
                  ...
                  <div className='flex gap-4 items-center'>
                    {imagesPreview?.map((item:any) => {
                        return (
                            <div key={item} className='relative w-[150px ] h-[150px ] '>
                                <img src={item} alt="preview" className='w-[100%] h-[100%] object-cover rounded-md' />
                                <span
                                    title='Xóa'
              ...
              <div className="flex m-[20px] items-center justify-center ">
                <button  className='px-[20px] bg-green-600 text-white' >Tạo mới</button>
              </div>
            </div>
          </div>
          </div>
