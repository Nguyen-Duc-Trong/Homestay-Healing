...
import { apiGetPrices, apiGetProvinces, apiGetAcreages } from '../../../service/price.js'
const Posting = () => {
...
const getData = async ()=>{
  const [apiPrices, apiProvinces, apiAcreages] = await Promise.all([
    apiGetPrices(),
    apiGetProvinces(),
    apiGetAcreages(),
  ]);
