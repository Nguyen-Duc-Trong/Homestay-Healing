...
const Posting = () => {
  ...
  const handleFile = async (e:any) => {
    ...
    Array.from(files).forEach((i:any) => {
      images.append("file", i);
      images.append("upload_preset", uploadAssetsName)
    })
    const response = apiUploadImages(images)
        ...
        <div className="flex pb-[200px]">
          <div className="w-2/3">
            ...
            <div className="w-full">
              ...
              <input onChange={ handleFile} value='' hidden type="file" id="img" multiple />
              </div>
            </div>
          </div>
          </div>
