          ...
          <div className="w-2/3">
            ...
            <div className="">
              ...
              <div className="">
                ...
                <input readOnly  className='border-[1px] outline-none bg-gray-200 w-[100%]'  type="text" id='contact' />
                <label className='font-medium' htmlFor='sdt'>Số điện thoại</label> <br />
                <input readOnly  className='border-[1px] outline-none bg-gray-200 w-[100%]'  type="text" id='sdt' />
              </div>
              </div>
            </div>
          </div>
