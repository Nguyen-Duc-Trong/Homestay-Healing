...
const Address = ({ setPayload }) => {
    ...
    console.log("huyện " +district , typeof district);
    ...
    const reusult = districts?.find((item:any)=> item.district_id === district)
    console.log(reusult?.district_name);
        ...
        <div>
            ...
            <div className='flex flex-col gap-4'>
                ...
                <div className="flex flex-col">
                    ...
                    value={`
                            ${district ? `${districts?.find((item:any) => item.district_id === district)?.district_name},` :''} 
                            ${province ? provinces?.find((item:any) => item.province_id === province)?.province_name : ''}
                          `}
                    />
                </div>
                {/* <InputReadOnly
