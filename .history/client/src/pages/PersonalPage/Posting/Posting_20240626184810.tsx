        ...
        <div className="flex pb-[200px]">
          <div className="w-2/3">
            ...
            <div className="">
              ...
              <div className="">
              <label className='font-medium' htmlFor='star'>Diện tích</label> <br />
              <input className='border-[2px] w-[30%]' type="number" id='star' /><button className='px-[5px] bg-gray-200'>m<sup>2</sup></button>
              </div>
              <div className="">
