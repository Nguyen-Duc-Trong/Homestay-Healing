          ...
          <div className="w-2/3">
            ...
            <div className="">
              ...
              <div className="">
                ...
                <input readOnly className='border-[2px] w-[100%]' type="text" id='contact' />
                <label className='font-medium' htmlFor='sdt'>Số điẹn thoại</label> <br />
                <input readOnly className='border-[2px] w-[100%]' type="text" id='sdt' />
              </div>
              </div>
            </div>
          </div>
