...
const Address = ({ setPayload }) => {
    ...
    //     setPayload((prev:any) => ({
    //         ...prev,
    //         address: `${district ? `${districts?.find((item:any) => item.district_id === district)?.district_name},` : ''} ${province ? provinces?.find(item => item.province_id === province)?.province_name : ''}`,
    //         province: province ? provinces?.find((item:any) => item.province_id === province)?.province_name : ''
    //     }))
