        ...
        <div className="flex pb-[200px]">
          <div className="w-2/3">
            ...
            <div className="">
              ...
              <br />
              <div className="">
              <label className='font-medium' htmlFor=''>Diện tích</label> <br />
              <input className='border-[2px] w-[30%]' type="number" id='acreage' /><button className='p-[5px] bg-gray-200'>m<sup>2</sup></button>
              </div>
              <div className="">
