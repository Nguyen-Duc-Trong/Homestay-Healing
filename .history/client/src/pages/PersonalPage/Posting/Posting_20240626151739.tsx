          ...
          <div className="w-2/3">
            ...
            <div className="">
              ...
              <div className="">
                ...
                <input value={username} readOnly  className='px-[5px] border-[1px] outline-none bg-gray-200 w-[100%]'  type="text" id='contact' />
                <label className='font-medium' htmlFor='sdt'>Số điện thoại</label> <br />
                <input value={phone} readOnly  className='px-[5px] border-[1px] outline-none bg-gray-200 w-[100%]'  type="text" id='sdt' />
              </div>
              </div>
            </div>
          </div>
