      ...
      <div className='w-[70%]'>
        ...
        <div className='p-[20px] bg-[#fff]'>
          ...
          <div className='mt-[10px]'>
            ...
            <div className='flex'>
              <div className='w-[30%]'>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>Mã tin: </p>
                <p className='text-[15px] mb-[15px]'>Khu vực: </p>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>Loại tin rao: </p>
                <p className='text-[15px] mb-[15px]'>Đối tượng thuê:</p>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>Gói tin:</p>
                <p className='text-[15px] mb-[15px]'>Ngày đăng:</p>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>Ngày hết hạn:</p>
              </div>
              <div className='w-[70%]'>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>{Overviews?.code}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.area}</p>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>{Overviews?.type}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.target}</p>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>{Overviews?.bonus}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.created}</p>
                <p className='text-[15px] mb-[15px] bg-[#f5f5f5]'>{Overviews?.expire}</p>
              </div>
            </div>
