    ...
    <div className='flex w-full'>
      ...
      <div className='w-[30%] pl-[15px]'>
          <div className='bg-[#febb02] border-[1px] rounded-[5px] border-[#febb02] p-[15px]'>
            ...
            <Button text={'Nhắn Zalo'} onClick={undefined} className={'w-full h-[40px] bg-[#fff] font-bold text-[#000000] text-[14px] mb-[10px]'} icon={<SiZalo size={10} className='text-[#fff] w-[30px] h-[30px] rounded-[50%] bg-[#028fe3] p-[5px] font-bold'/>}/>
            <Button text={'Đặt Phòng'} onClick={undefined} className={'w-full h-[40px] bg-[#fff] font-bold text-[#000000] text-[14px]'} icon={ <GoHeartFill size={20} color='#f73859'/>}/>
          </div>
      </div>
