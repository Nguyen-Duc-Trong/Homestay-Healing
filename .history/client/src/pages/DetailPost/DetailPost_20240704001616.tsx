    ...
    <div className='flex w-full'>
      ...
      <div className='w-[30%] pl-[15px]'>
          <div className='bg-[#febb02] border-[1px] rounded-[5px] border-[#febb02] p-[15px]'>
            ...
            <Button text={'Yêu Thích'} onClick={undefined} className={'w-full h-[40px] bg-[#fff] font-bold text-[#000000] text-[14px]'} icon={ <GoHeartFill size={20} color='#f73859' className='mr-[0px]'/>}/>
          </div>
      </div>
