    ...
    <div className='flex w-full'>
      ...
      <div className='w-[30%] pl-[15px]'>
          <div className='bg-[#febb02] border-[1px] rounded-[5px] border-[#febb02] p-[15px]'>
            ...
            <div className='flex cursor-pointer items-center justify-center h-[40px] bg-[#fff] rounded-[5px] font-bold text-[#000000] text-[14px] py-[3px] mb-[10px]'>
              Nhắn Zalo
            </div>
            <div className='flex cursor-pointer items-center justify-center h-[40px] bg-[#fff] rounded-[5px] font-bold text-[#000000] text-[14px] py-[3px]'>
