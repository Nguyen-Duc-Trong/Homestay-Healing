    ...
    <div className='flex w-full'>
      ...
      <div className='w-[30%] pl-[15px]'>
          <div className='bg-[#febb02] border-[1px] rounded-[5px] border-[#febb02] p-[15px]'>
            ...
            <Button text={users?.phone} onClick={undefined} className={'w-full h-[40px] bg-[#16c784] hover:bg-[#13bb7b] font-bold text-white text-[21px] mb-[10px] hover:no-underline'} icon={<FaPhoneAlt className='mr-[5px]'/>}/>
            <Button text={'Nhắn Zalo'} onClick={undefined} className={'w-full h-[40px] bg-[#fff] font-bold text-[#000000] text-[14px] mb-[10px]'} icon={undefined}/>
            <Button text={'Yêu Thích'} onClick={undefined} className={'w-full h-[40px] bg-[#fff] font-bold text-[#000000] text-[14px]'} icon={ <GoHeartFill size={20} color='#f73859'/>}/>
          </div>
      </div>
