      ...
      <div className='w-[70%]'>
        ...
        <div className='p-[20px] bg-[#fff]'>
          ...
          <div className='mt-[10px]'>
            ...
            <div className='flex'>
              <div className='w-[30%]'>
                <p className='text-[15px] mb-[15px]'>Mã tin: </p>
                <p className='text-[15px] mb-[15px]'>Khu vực: </p>
                <p className='text-[15px] mb-[15px]'>Loại tin rao: </p>
                <p className='text-[15px] mb-[15px]'>Đối tượng thuê:</p>
                <p className='text-[15px] mb-[15px]'>Gói tin:</p>
                <p className='text-[15px] mb-[15px]'>Ngày đăng:</p>
                <p className='text-[15px] mb-[15px]'>Ngày hết hạn:</p>
              </div>
              <div className='w-[70%]'>
