    ...
    <div className='flex w-full'>
      ...
      <div className='w-[30%] pl-[15px]'>
          <div className='bg-[#febb02] border-[1px] rounded-[5px] border-[#febb02] p-[15px]'>
            ...
            <div className='flex items-center justify-center bg-[#16c784] rounded-[5px] font-bold text-white text-[21px] py-[3px]'>
              <FaPhoneAlt className='mr-[5px]'/>
              {users?.phone}
            </div>
            <div className='flex items-center justify-center bg-[#fff] rounded-[5px] font-bold text-[#000000] text-[21px] py-[3px]'>
              Nhắn zalo
            </div>
          </div>
      </div>
