...
const { IoStarSharp, FaLocationDot, GiPriceTag, SlCrop} = icons
      ...
      <div className='w-[70%]'>
        ...
        <div className='p-[20px]'>
          ...
          <div className='mt-[10px]'>
            ...
            <div className='flex'>
              <p className='flex items-center'><GiPriceTag/> Price: {attributes.price}</p>
              <p><SlCrop/> {attributes.acreage}</p>
              <p> {attributes.published}</p>
              <p>{Overviews?.code}</p>
            </div>
