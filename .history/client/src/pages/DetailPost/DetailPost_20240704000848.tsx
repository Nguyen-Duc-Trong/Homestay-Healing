    ...
    <div className='flex w-full'>
      ...
      <div className='w-[30%] pl-[15px]'>
          <div className='bg-[#febb02] border-[1px] rounded-[5px] border-[#febb02] p-[15px]'>
            ...
            <Button text={users?.phone} onClick={undefined} className={'w-full h-[40px] bg-[#16c784] hover:bg-[#13bb7b] font-bold text-white text-[21px]'} icon={<FaPhoneAlt className='mr-[5px]'/>}/>
            {/* <div className='cursor-pointer flex items-center justify-center h-[40px] bg-[#16c784] hover:bg-[#13bb7b] rounded-[5px] font-bold text-white text-[21px] py-[3px] mb-[10px]'>
              <FaPhoneAlt className='mr-[5px]'/>
              {users?.phone}
            </div> */}
