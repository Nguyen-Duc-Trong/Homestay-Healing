        ...
        <div className='p-[20px] bg-[#fff]'>
          ...
          <div className='mt-[10px]'>
            ...
            <div className='flex'>
              ...
              <div className='w-[70%]'>
                <p className='text-[15px] mb-[15px]'>{Overviews?.code}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.area}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.type}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.target}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.bonus}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.created}</p>
                <p className='text-[15px] mb-[15px]'>{Overviews?.expire}</p>
              </div>
            </div>
