...
const handleShowBookRoom = (item: any, name: any) => {
  ...
  return (
    <div className='w-full'>
      ...
      {isShowBookRoom && <PopupBookRoom handleSubmit={''} name={''} content={''} setIsShowBookRoom={setIsShowBookRoom} queries={undefined} />}
