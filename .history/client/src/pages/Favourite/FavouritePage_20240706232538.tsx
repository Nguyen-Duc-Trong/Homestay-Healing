...
const Favourite = () => {
  ...
  useEffect(() => {
    getDataBookRoom()
    getPost()
    dispatch(setTotalCartRoom(listFavorite?.length-1))
  }, [])
...
const handleDelete = async (idPost:any)=>{
  ...
  return (
    <div className='favourite'>
      ...
      <h2>Số phòng đã lưu: {listFavorite ? listFavorite?.length : 0} </h2>
      <div className="w-[100%] flex">
        <div className={`w-[70%] bg-white rounded-lg ${listFavorite.length > 0 ? "" : "h-[250px]"}  mr-[10px] mt-[15px] p-[10px]`}>
