...
const PopupBookRoom = ({ setIsShowBookRoom, item, handleSubmit }) => {
    ...
    // Chuyển đổi giá thuê tháng sang giá thuê ngày
    const monthlyRateString = item?.attributes?.price;
    const monthlyRate = Number(monthlyRateString);

    // Kiểm tra nếu monthlyRate không hợp lệ thì gán giá trị mặc định là 0
    const dailyRate = !isNaN(monthlyRate) ? monthlyRate / 30 : 0;
