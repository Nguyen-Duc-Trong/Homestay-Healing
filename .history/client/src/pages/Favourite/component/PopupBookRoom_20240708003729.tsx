    ...
    return (
        <div onClick={() => { setIsShowBookRoom(false) }} className='fixed top-[0px] left-0 right-0 h-screen w-[100%] z-[1000] bg-[#00000080] flex justify-center '>
            <div onClick={(e) => {
                ...
                <Button text={'Xác Nhận'} onClick={undefined} className={'bg-[#00fff6] w-full rounded-t-none hover:no-underline hover:bg-red-500 text-[18px]'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined} />
            </div>
        </div>
    )
}
