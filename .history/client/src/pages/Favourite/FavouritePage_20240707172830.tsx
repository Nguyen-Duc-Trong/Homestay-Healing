                  ...
                  return (
                    <div key={index} className="flex">
                      ...
                      <div className='w-[20%] pt-[30px['>
                        <Button text={'Đặt Phòng'} onClick={undefined} className={'w-full text-center bg-[#febb02] text-[#000000] font-bold hover:no-underline mb-[10px]'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined} />
                        <Button text={undefined} onClick={() => handleDelete(item?.id)} className={'w-full text-center bg-red-500 hover:bg-cyan-400'} icon={<FaTrashCan />} bgColor={undefined} textColor={undefined} px={undefined} />
                      </div>
                    </div>
                  )
                })
