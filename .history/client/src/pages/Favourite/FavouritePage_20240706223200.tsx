...
const Favourite = () => {
  const [listFavourite, setListFavorite] = useState<string[]>([])
  ...
  useEffect(() => {
    ...
    const filteredData = dataPost?.filter((item:any) => listFavourite?.includes(item?.id));
      ...
      <div className="w-[100%] flex">
        <div className={`w-[70%] bg-white rounded-lg ${listFavourite.length > 0 ? "" : "h-[250px]"}  mr-[10px] mt-[15px] p-[10px]`}>
            ...
            <div className="">
              ...
              {
                filData?.map((item:any ,index:any)=>{
                return (
