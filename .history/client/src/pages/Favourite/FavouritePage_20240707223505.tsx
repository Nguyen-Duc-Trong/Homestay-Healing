...
const handleShowBookRoom = (content: any, name: any) => {
                  ...
                  return (
                    <div key={index} className="flex my-[15px] border-b-[1px] border-gray-500 border-dashed pb-[15px] cursor-pointer">
                      ...
                      <div className='w-[20%] pt-[30px]'>
                        <Button text={'Đặt Phòng'} onClick={handleShowBookRoom} className={'w-full text-center bg-[#febb02] hover:bg-yellow-600 text-[#000000] font-bold hover:no-underline mb-[10px]'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined} />
