              ...
              {/* <h3 className='text-[1.5rem] mb-[5px] leading-[1.2rem] font-[600]'>Danh sách tin đăng</h3> */}
              {
                ...
                return (
                  <div key={index} className="flex">
                      ...
                      <div className='w-[20%]'>
                        <Button text={undefined} onClick={()=> handleDelete(item?.id)} className={undefined} icon={<FaTrashCan/>} bgColor={undefined} textColor={undefined} px={undefined}/>
                        <Button text={'Đặt Phòng'} onClick={undefined} className={'w-full text-center bg-[#febb02] text-[#000000] hover:no-underline'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined}/>
                      </div>
                  </div>
                )
                })
