                ...
                return (
                  <div key={index} className="flex">
                      ...
                      <div className='w-[20%]'>
                        ...
                        <Button text={'Đặt Phòng'} onClick={undefined} className={'w-full text-center bg-red-500 text-[#fff] hover:no-underline'} icon={undefined} bgColor={undefined} textColor={undefined} px={undefined}/>
                      </div>
                  </div>
                )
                })
