  ...
  return (
    <div className='w-full'>
      ...
      <div className="w-[100%] flex mb-[40px] shadow-lg">
        <div className={`w-full bg-white rounded-lg ${listFavorite.length > 0 ? "" : "h-[250px]"} mt-[15px] p-[10px]`}>
          {listFavorite.length > 0 ?
            <div className="">
              {
                newFilteredData?.map((item: any, index: any) => {
                  return (
                    <div key={index} className="flex my-[15px] border-b-[1px] border-gray-500 border-dashed pb-[15px]">
