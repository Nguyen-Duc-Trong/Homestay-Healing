...
const PopupSearch = ({setIsShowModal, content, name, handleSubmit}:any) => {
              ...
              {content?.map((item:any) => {
                return(
                  <span key={item.code} className='py-[5px] flex gap-2 items-center border-b-[1px]'>
                    <input type='radio' name={name} id={item.code} value={item.code} onClick={(e) => handleSubmit(e,{[name]: item.code})} />
