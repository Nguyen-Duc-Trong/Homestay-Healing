...
import Input from '../../../components/Input/Inputtsx'
const { FaArrowLeft} = icons

const Modal = ({setIsShowModal, content, name}:any) => {
              ...
              {content?.map((item:any) => {
                return(
                  <span className='py-[5px]'>
                    ...
                    <Input label={undefined} value={item.code} setValue={undefined} keyPayload={undefined} invalidFields={undefined} setInvalidFields={undefined} type={'radio'}  />
                  </span>
                )
              })}
            </div>
