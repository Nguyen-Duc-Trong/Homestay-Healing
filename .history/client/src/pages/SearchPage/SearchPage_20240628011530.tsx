...
import Button from '../../components/Button/Button.tsx';
import PopupSearch from './component/PopupSearch.tsx';
import { setProvince, setCategory,setAcreages } from '../../redux/slides/searchSlide.js';
import { apiGetProvinces } from '../../service/province.js';
import { apiGetCategories } from '../../service/category.js';
...
// ????? còn cái area2 nè
  ...
  useEffect(() => {
    ...
    const getAcreages = async () => {
      const response2 = await apiGetAcreages();
      console.log(response2);
      dispatch(setAcreages(response2?.data?.response));
    };
    getCategory();
    getProvince();
    getAcreages()
